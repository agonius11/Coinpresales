  ...
  return (
    <div className="min-h-screen py-12 md:py-20 relative">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-teal-500/20 rounded-full blur-3xl"></div>
      </div>

      <div className="container-max-w max-w-4xl relative z-10">
        <div className="dark-card p-8 md:p-12 rounded-3xl shadow-2xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <div className="glass border border-yellow-500/50 p-6 rounded-lg mb-6 glow-purple">
                <p className="font-bold text-lg text-yellow-400 mb-3">
                  IMPORTANT NOTICE:
                </p>
            ...
            <section className="mb-10">
              ...
              <div className="glass p-6 rounded-lg border border-teal-400/30 glow-teal">
                <p className="font-semibold text-white text-lg mb-2">
                  Coin Trends News
                </p>
                <p className="text-gray-300">Email: legal@cointrendsnews.com</p>
