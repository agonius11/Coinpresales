          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <ul className="list-disc pl-6 text-gray-300 space-y-3">
                <li>
                  <strong className="text-teal-400">Service Providers:</strong>{" "}
                  With trusted third-party service providers who assist in
                  operating our website and delivering our services (e.g., email
                  service providers)
                </li>
                <li>
                  <strong className="text-teal-400">Legal Requirements:</strong>{" "}
                  When required by law or to respond to legal process
                </li>
                <li>
                  <strong className="text-teal-400">Business Transfers:</strong>{" "}
                  In connection with a merger, acquisition, or sale of assets
                </li>
                <li>
                  <strong className="text-teal-400">Consent:</strong> With your
                  explicit consent
                </li>
              </ul>
            </section>
