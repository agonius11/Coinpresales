      ...
      {latestArticles.length > 0 ? (
          ...
          <div className="container-max-w relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Featured <span className="text-teal-400">Posts</span>
              </h2>
            ...
            <div className="text-center">
              <Link
                href="/articles"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full text-gray-900 font-semibold bg-teal-400 hover:bg-teal-300 transition-all duration-300 ease-in-out shadow-lg transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 focus:ring-offset-gray-900 text-lg"
              >
        ...
        <section className="section-padding">
          <div className="container-max-w text-center">
            <div className="glass-strong p-12 rounded-2xl max-w-2xl mx-auto">
